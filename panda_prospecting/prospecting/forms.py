...
class ProspectForm(forms.ModelForm):
    class Meta:
        model = Prospect
        fields = ['full_name', 'title', 'email', 'phone', 'street', 'city', 'state', 'zipcode', 'country', 'linkedin', 'prospect_status', 'prospect_notes']
        labels = {'full_name': 'Prospect Name', 'title': 'Title', 'email':'Email',
                  'phone':'Phone', 'street':'Street', 'city':'City', 'state':'State', 'zipcode':'ZipCode', 'country':'Country', 'linkedin':'LinkedIn', 'prospect_status': 'Prospect Status', 'prospect_notes':'Prospect Notes'}
